...
| --- | --- |
| Publishing this tree as a site anyone can reach | [`@monorepo/tech-docs`](../apps/tech-docs/README.md) renders it locally — `pnpm tech-docs` — reading these files in place rather than copying them. Publishing is the different problem: nothing here is authenticated and every path it prints is a local file |
