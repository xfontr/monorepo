...
Public-facing Nuxt 4 app. Presentation layer only — it composes shared packages (`@monorepo/ui`, `@monorepo/i18n`) and holds no domain logic.
...
`@monorepo/i18n/nuxt` module: it installs and configures `@nuxtjs/i18n`, registers the
